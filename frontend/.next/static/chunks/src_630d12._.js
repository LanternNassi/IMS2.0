...
const page = ()=>{
    ...
    const { fetchCustomers, getCustomerById, deleteCustomer, createCustomer, searchCustomerTags, isLoading, customers, pagination } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useCustomerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerStore"])();
...
_s(page, "R6lLBK/rYli6/kYmiRfazoee/f4=", false, function() {
    return [
