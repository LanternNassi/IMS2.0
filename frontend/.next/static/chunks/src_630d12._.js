(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_630d12._.js", {
...
"[project]/src/store/useCustomerStore.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const useCustomerStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["create"])((set)=>({
        isLoading: false,
        customers: null,
        customerTags: null,
        pagination: null,
        fetchCustomers: async (keywords, page)=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/Customers', {
                params: {
                    keywords,
                    page
                }
        ...
        fetchCustomerTags: async (keywords, customer)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/Customers/Tags', {
                params: {
                    keywords,
                    customer
                }
        ...
        searchCustomerTags: async (keywords)=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/Customers/Tags`, {
                params: {
                    keywords
                }
            });
        ...
        addCustomerToTags: async (customer, tags, onsuccess, onFailure)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`/Customers/${customer}/tags`, tags).then((response)=>{
                if (response.status == 200) {
                    onsuccess();
                } else {
                    onFailure();
        ...
        getCustomerById: async (id)=>{
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/Customers/${id}`);
            return response.data;
        },
        createCustomer: async (customer, onsuccess, onFailure)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/Customers', customer).then((response)=>{
        ...
        updateCustomer: async (customer, onsuccess, onFailure)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/Customers/${customer.id}`, customer).then((response)=>{
                if (response.status == 200) {
                    onsuccess();
                } else {
                    onFailure();
        ...
        deleteCustomer: async (id, onsuccess, onFailure)=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$Utils$2f$Request$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`Customers/${id}`).then((response)=>{
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useCustomerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/store/useCustomerStore.ts [app-client] (ecmascript)");
...
const page = ()=>{
    ...
    const { fetchCustomers, getCustomerById, deleteCustomer, createCustomer, searchCustomerTags, updateCustomer, isLoading, customers, pagination } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useCustomerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerStore"])();
...
_s(page, "UxpcAjtlbP296WtDvgn1gKUCn5Y=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$useCustomerStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCustomerStore"]
    ];
});
...
"[project]/src/app/Customers/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_630d12._.js.map